# Agent Enterprise External Monorepo

This repository is the sanitized external-collaboration copy of Agent Enterprise.

It exists so an external agent can work across the broader project with full code and planning context, without receiving live-operational access to cPanel, databases, mailboxes, secrets, or local runtime state.
...
- planning/history context under `.planning/`
- project-local skills under `.agents/`
