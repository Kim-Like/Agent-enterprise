...
> External monorepo note: this repo preserves architecture context, but excludes live secret-bearing state and treats SSH/cPanel/DB/email execution as operator-only.
