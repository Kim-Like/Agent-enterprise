...
> Operator-only execution doc: keep this for context and handoff accuracy, but do not execute the SSH, cPanel, DB, mail, or rollout steps from the external monorepo. Use `OPERATOR_HANDOFF_CONTRACT.md` instead.
