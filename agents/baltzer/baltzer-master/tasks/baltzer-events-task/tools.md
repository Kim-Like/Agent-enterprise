# Baltzer Events Task - Tools

## Primary Tooling
- Event module placeholder under `programs/baltzer/event-management-platform`.
- Task queue with explicit dependency and handoff fields.
- Observability hooks to surface blockers before live events.
