# Baltzer Accounting Integration Task - Skills

## Domain Competencies
1. Accounting sync pipelines aligned to Baltzer reporting and finance timelines.
2. Cross-system reconciliation with deterministic audit traces.
3. Failure classification and reprocessing strategy for partial sync runs.
