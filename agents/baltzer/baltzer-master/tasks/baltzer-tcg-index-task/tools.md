# Baltzer TCG Index Task - Tools

## Primary Tooling
- TCG index app at `programs/baltzer/TCG-index`.
- Local datastore migration workflows with schema discipline.
- Telemetry checks for stale price windows and pipeline breaks.
