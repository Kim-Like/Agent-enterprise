# Baltzer TCG Index Task - Skills

## Domain Competencies
1. TCG pricing ingestion and normalization across vendor signal sources.
2. Migration planning for pricing history and arbitrage indicators without third-party datastore coupling.
3. Latency/freshness-aware update scheduling for near-real-time decision support.
