...
- TCG index: migration-hold pending local datastore replacement
- reporting: local JSON + Billy API
- Shopify: cloud platform data model

## Current Priorities

1. ecommerce core stability
2. pricing/tracking accuracy in TCG index
3. staged rollout for events/workforce/salary integrations
