...
- PMO standards
- cross-program execution quality
...
1. maintain architecture discipline after consolidation
2. keep delegation, registry, and memory docs synchronized
3. drive quality gates for all domain masters
