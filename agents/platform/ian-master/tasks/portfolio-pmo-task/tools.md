# Portfolio PMO Task - Tools

## Primary Tooling
- PMO workflow artifacts in `task_queue`, `error_log`, and registry tables.
- System-map and datastore verification routes for portfolio health checks.
- Dashboard views for operations review over Tailscale/local endpoints.
