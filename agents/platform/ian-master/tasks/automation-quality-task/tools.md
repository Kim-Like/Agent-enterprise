# Automation Quality Task - Tools

## Primary Tooling
- Cross-program quality artifacts in `task_queue` and `execution_history`.
- Pytest/check pipelines and endpoint smoke validation routines.
- Issue backlog management in `error_log` with owner assignment.
