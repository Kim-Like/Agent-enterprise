# IAn Implementation Task - Tools

## Primary Tooling
- Canonical root `/Users/IAn/Agent/IAn` and program registry metadata.
- FastAPI/SQLite control-plane stack and task routing APIs.
- Engineer handoff protocol for specialized deep implementation.
