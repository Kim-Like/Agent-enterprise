# LPH Subscription Ops Task - Skills

## Domain Competencies
1. Subscription lifecycle modeling: activation, churn, retention, expansion.
2. Client portfolio health scoring and renewal risk triage.
3. Ops dashboard design for recurring revenue and service-level visibility.
