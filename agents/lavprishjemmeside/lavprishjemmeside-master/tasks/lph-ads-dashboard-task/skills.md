# LPH Ads Dashboard Task - Skills

## Domain Competencies
1. Paid media data ingestion and normalization across campaign/ad-set/ad levels.
2. Performance metric modeling for CAC, ROAS, CTR, conversion quality.
3. Rate-limit-safe sync orchestration and retry/backoff strategies.
