# Artisan Brevo Lifecycle Task - Tools

## Primary Tooling
- Brevo API and campaign/contacts tooling.
- Responsive email QA matrix for Gmail, Apple Mail, and Outlook.
- Queue/error visibility through `/api/tasks` and `/api/errors`.
