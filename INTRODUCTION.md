...
> External monorepo note: this repo is a sanitized collaboration copy. Live secrets, runtime state, SSH executors, and direct cPanel/DB/email operations are intentionally excluded or operator-blocked here.
